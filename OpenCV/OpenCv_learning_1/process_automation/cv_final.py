...
def ping_on_slack(file):
    try:
        slack_token = 'xoxp-393473516853-392784516193-426128841152-609b3ed952203da1022d096b87deb3e3'
        sc = SlackClient(slack_token)

        sc.api_call(
            "chat.postMessage",
            channel="spy-cam-opencv",
            text="File created : " + file + " :tada:"
        )
        print("Alerted in slack")
    except:
